...
<span id="prevwinealert" style="text-align:center;font-size:12px;color:red;"></span>
</div>
<hr style="margin-top: 0px;margin-bottom: 5px;">

<button class="btn btn-primary addpreviousselectedWine" style="line-height: 0.8;border-radius: 12px;margin-left: 300px;"> Add </button>