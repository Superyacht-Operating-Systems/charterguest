...
<nav class="menu"> 
        ...
        <?php }else{ ?>
            <li>Yachts Website</li>
        <?php } ?>
         <?php if($map_url == 'link'){ ?>

            <?php //echo $guesttype; 
            if(isset($guesttype) && $guesttype == 'guest'){ ?>
                <li><a href="<?php echo $basefolder."/charters/charter_program_map/".$charter_program_id.'/'.$yachtdb.'/'.$guesttype.'/'.$cp_guesttype.'/'.$allow_comments; ?>" title="Map is Published">Cruising Map</a></li>
            <?php }else{ ?>
                <li><a href="<?php echo $basefolder."/charters/charter_program_map/".$charter_program_id.'/'.$yachtdb.'/'.$guesttype.'/'.$cp_guesttype; ?>" title="Map is Published">Cruising Map</a></li>
        ...
        <li class="menu__item"> <a href="<?php echo $basefolder."/charters/view_guest/".$id."/".$charter_program_id."/".$fleetcompany_id.'/'.$yachtdb.'/guest'.'/'.$cp_guesttype.'/'.$allow_comments; ?>">Guest List</a></li>
        ...
        <?php } ?>
           ...
           <ul class="submenu">
           <li class="menu__item" id="MenuHowToVideo"><a  href="https://www.youtube.com/watch?v=dQFHpxENsPk">Preference Sheets</a></li>
                   <li class="menu__item" id="MenuHowToVideoCharterHead"><a href="https://youtu.be/uk_hTLv8LkM">Head Charterer</a></li>
