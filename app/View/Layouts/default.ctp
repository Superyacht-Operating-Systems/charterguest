  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content mc-bord  videomodalcontent">
     <div class="modal-header">
        ...
        <div class="modal-body">
        <video width="100%" height="100%" class="video videoclass" webkit-playsinline playsinline autoplay muted loop controls="true"  preload="auto" id="preferencesheetvideo">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content mc-bord  videomodalcontent">
     <div class="modal-header">
        ...
        <div class="modal-body">
        <video width="100%" height="100%" class="video videoclass" webkit-playsinline playsinline autoplay muted loop controls="true"  preload="auto" id="charterheadvideo">
