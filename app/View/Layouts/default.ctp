...
.modalmsg-container .modal-footer {
    text-align: center;
}
                ...
                <nav role="navigation" class="navbar navbar-inverse navbar-absalute-top">            
                    ...
                    <div class="label-bold-head mydemolabel">
                      <?php if($programpageCharter == "charters" && $programpagePrograms != "programs" && $programpagePrograms == "preference"){ 
                        ...
                        if(isset($session['preferenceGuestName'])){
                      ...
                      <?php } else if(($programpageCharter == "charters" && $programpagePrograms != "programs") && ($programpageCharter == "charters" && $programpagePrograms != "memories") && ($programpageCharter == "charters" && $programpagePrograms != "presentations")){ ?>
                    ...
                    <div class="yachtHeaderName"><?php if(($programpageCharter == "charters" && $programpagePrograms != "presentations")){ ?>Charter Guest <?php } ?><?php if(($programpageCharter == "charters" && $programpagePrograms == "presentations")){ ?><?php echo $session['yachFullName'];  ?> <?php } ?>
...
<!--      <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="modalmsg">
          <button type="button" class="close" aria-label="Close" onclick="$('#PreferenceAlreadyExist').hide();">
          <span aria-hidden="true">&times;</span>
        </button>
            <p>Preferences for : <span  class="chr-block"><b id="guestFullName"></b></span></p>
            <p>Last Updated : <span  class="chr-block"><b id="guestLastUpdated"></b></span></p>
...
// Show last 100 years (from current year backwards)
var dobYearRange = (currentYear - 100) + ":" + currentYear;
// DOB
        ...
        $.ajax({
            ...
            success:function(result) {
                ...
                if (result.status == 'success') {
                    ...
                    $("#guestLastUpdated").text(result.psheetModified);
...
/// existing preference
  ...
  $(document).on("click", ".download", function(e) { //alert()
            ...
            success:function(result) {
              $("#hideloader").hide();
                if (result.status == 'success') {
                    ...
                    DownloadFile(result.link,result.file);
