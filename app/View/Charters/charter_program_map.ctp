...
<?php } ?>
// middle line
var polyline0 = new L.Polyline(latlongstemp, {snakingSpeed: 300,stroke:true,weight:4,dashArray: [10,10],lineCap: "round",lineJoin: "round",smoothFactor: 3}).addTo(map).snakeIn();
//map.fitBounds(latlngs);
