                ...
                $attachment = $schedule['CharterProgramSchedule']['attachment'];
                       ...
                       <div class="inputContainer_div">
                            <div class="loc_desc_div">
                                <div>
                                <span style="display: inline-block;position: relative;"><img src="<?php echo $markerimage; ?>" style="object-fit: fill; height: 35px;" alt="" ><span style="position: absolute;color:#000;top: 4.5px;right: 0px;left: -2px;text-align: center;font-size: 14px;"><?php echo $daynumber; ?></span></span>
                            ...
                            <div class="loc_img_div">
                                <div class="loc_map_div loadEnlargemap" id="crusingschedulemap<?php echo $crusemap; ?>" data-mindex="<?php echo $crusemap; ?>">
...
$(document).on("click", ".loadEnlargemap", function(e) {
    //e.stopImmediatePropagation();
    // e.preventDefault();
    var mapindex = $(this).attr('id');
    var mindex = $(this).attr('data-mindex');
     console.log(mindex);
    // L.DomEvent.stopPropagation(e);
     //$(".mylocsh"+mindex).click();
    
});
 
// function loadEnlargemap(index){
// console.log(index);
//      //var mapindex = index;
//     // if (mapindex < markerCount) {
//     //     return;
//     // }
//      $(".mylocsh"+index).click();
//     //return false;
