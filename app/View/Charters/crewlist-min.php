...
<div class="owl-carousel owl-theme ">
    <?php foreach($CrewInfo as $val){ $SITE_URL = "https://charterguest.net/charterguest/"; 
   // $SITE_URL = "http://localhost/charterguest/";
    // 
    // ?>
<!-- Head Charterer info -->
<div class="charterRow mobviewheight notmobleftpad">
    <div class="">
        <div class="row col-md-12">
            <div class="col-md-9 notmob"><h2 class="titlenotmob"><span class="crew-flag"><img src="<?php echo $SITE_URL.'app/webroot/img/uk-f.jpg'; ?>"></span><?php echo $val['User']['first_name'].' '.$val['User']['last_name']; ?> - <?php echo $val['Position']['position_name']; ?></h2></div>
        ...
        <div class="row col-md-12 ">
            <div class="col-md-3 w-md03  crewimgleft" style="float:right;">
                    ...
                    <div class="mobdisplay"><span class="crew-flag"><img src="<?php echo $SITE_URL.'app/webroot/img/uk-f.jpg'; ?>"></span><p><h3 class="mobh3"><?php echo $val['Position']['position_name']; ?></h3></p><p><h3 class="mobh3"><?php echo $val['User']['first_name'].' '.$val['User']['last_name']; ?></h3></p></div>
            </div>
